...
double wheel_speed_threshold = 6.275*0.98; //max value minus a small epsilon, lowered so that the followers can follow
...
void control_update()  
{
	...
	control_vector = pose_add(pose_scale(0,migration_vector), pose_scale(0.5,consensus_vector));
